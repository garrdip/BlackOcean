...
public class Boss_Apates : SpawnedMonster
{
    ...
    public override void OnStartClient()
    {
        ...
        // 아파테스 BGM 재생
        AudioClip momosBGM = M_SoundManager.instance.GetBGMClip(BGM_TYPE.Boss, "Boss_Apates");
        ...
        if(NetworkClient.localPlayer != null){
            ...
            switch(character){
                case Character.HONGDANHYANG:
                    apatesVoice = M_SoundManager.instance.GetVoiceClipAt(VOICE_TYPE.Apates, 9);
                    playerVoice = M_SoundManager.instance.GetVoiceClipAt(VOICE_TYPE.HongDanHyang, 156);
                    break;
                case Character.GEORK:
                    apatesVoice = M_SoundManager.instance.GetVoiceClipAt(VOICE_TYPE.Apates, 10);
                    playerVoice = M_SoundManager.instance.GetVoiceClipAt(VOICE_TYPE.Geork, 165);
                    break;
                case Character.ERIS:
                    int index = Random.Range(0, 1);
                    apatesVoice = M_SoundManager.instance.GetVoiceClipAt(VOICE_TYPE.Apates, 11);
                    playerVoice = M_SoundManager.instance.GetVoiceClipAt(VOICE_TYPE.Eris, 216);
