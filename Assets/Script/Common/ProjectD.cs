...
namespace ProjectD
{
    ...
    public enum RoomType { START_LOCATION, MONSTER, ELITE, EVNET_POSITIIVE, EVENT_NEGATIVE, CAMP, ITEM_NPC, CARD_NPC, UNDEFINED, COMPLETE, RUINS, BOSS }
    ...
    public enum BuffType { NONE, IRONDEMON, DEFENSE, ICHI_ATTACK, ICHI_DEFENSE , MOMISPOWERFUL, FLOWERPOWDER, FLOWER, CARDCOSTONE, SOIRAK, APDO, THEREISNOJABI, BOONGGUI, BYEOLMURI, SUHOJA, BLADETRIMMING, IMANGRY, E2, GROWTHSPURT, FURYOFFLOWER, FURYOFIRON, 
                            FRAGRANT, GOHANG3, GOHANG2_DEBUFF ,GOHANG3_DEBUFF, BOOKBANG, GOTONG, BRILLIANTCURSE, UGLYKNIGHT, ABSOLUTEDOMINATOR, WRAPWINGS, CLOSEPOSE, WISDOMOFOLDSOLDIER }
