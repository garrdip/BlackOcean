...
public partial class M_EffectManager
{
    ...
    [ClientRpc]
    public void RpcEffectEnergyExplosion(Vector3 position)
    {
        ParticleSystem particleSystem = Instantiate(danhyangCardEffectParticles[2], position + new Vector3(0f, 1.5f, 0f), Quaternion.identity); // EnergyExplosion 이펙트 파티클 생성
        ParticleSystemRenderer renderer = particleSystem.GetComponent<ParticleSystemRenderer>();
        renderer.sortingLayerName = "Effect";
    }
