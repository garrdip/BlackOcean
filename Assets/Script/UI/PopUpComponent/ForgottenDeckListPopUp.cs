...
public class ForgottenDeckListPopUp : SingletonD<ForgottenDeckListPopUp>, IPointerClickHandler
{
    ...
    {
        PopUpUIManager.instance.onChangeForgottenDeckPopUpShow += OnChangeForgottenDeckPopUpShow;
        PopUpUIManager.instance.onChangeForgottenDeckPopUpHide += OnChangeForgottenDeckPopUpHide;
    }

    void Start()
    {
        buttonExit.onClick.AddListener(() => {
            PopUpUIManager.instance.HandleHideForgottenDeckListPopUp();
        });
    }
    ...
    public void OnForgottenDeckUpdated(SyncList<Card>.Operation op, int index, Card oldVal, Card newVal)
    {
        switch (op)
        {
    ...
    public void OnChangeForgottenDeckPopUpShow()
    {
        canvasGroup.DOFade(1.0f, 0.5f);   
    }

    public void OnChangeForgottenDeckPopUpHide()
    {
