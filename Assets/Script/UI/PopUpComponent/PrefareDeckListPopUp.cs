...
public class PrefareDeckListPopUp : SingletonD<PrefareDeckListPopUp>, IPointerClickHandler
{
    ...
    {
        PopUpUIManager.instance.onChangePrefareDeckPopUpShow += OnChangePrefareDeckPopUpShow;
        PopUpUIManager.instance.onChangePrefareDeckPopUpHide += OnChangePrefareDeckPopUpHide;
    }

    void Start()
    {
        buttonExit.onClick.AddListener(() => {
            PopUpUIManager.instance.HandleHidePrefareDeckListPopUp();
        });
    }
    ...
    public void OnPrefareDeckUpdated(SyncList<Card>.Operation op, int index, Card oldPrefareDeck, Card newPrefareDeck)
    {
        switch (op)
        {
            case SyncList<Card>.Operation.OP_ADD:
                CreateDeck(newPrefareDeck);
                break;
            case SyncList<Card>.Operation.OP_INSERT:
                
                break;
            case SyncList<Card>.Operation.OP_REMOVEAT:
                RemoveDeck(oldPrefareDeck);
                break;
    ...
    public void OnChangePrefareDeckPopUpShow()
    {
        canvasGroup.DOFade(1.0f, 0.5f);   
    }

    public void OnChangePrefareDeckPopUpHide()
    {
