...
## 카드 감사(CARD_AUDIT.md) 후속 — 21·22회차 **미커밋**, 플레이 테스트 대기

21회차(명백 버그 14건) + 22회차(수치 8건, 설명 기준) 확인 포인트:

- [ ] G61 신의 뜻: 평상시 피해 2 / 영웅 상태 60 (종전 반대)
- [ ] H38 철의 장막: 자신 제외 **아군**이 방어 8 (종전엔 적이 받았음)
- [ ] G59 시체 걸기: 처치 시 남은 **적들**에게 압도 3
- [ ] G5 빌린 이름: 적 한명에게 쇠락 1 (타겟팅 화살표 정상 동작 포함)
- [ ] E30 창조의 권능: E10 2장이 **뽑을덱**으로
- [ ] H58 어버이의 후예들: H10번대 카드 미발동, 잊혀진덱 중복 없음
- [ ] G35/G36: 적만 타겟 가능 / H51: 아군 선택 가능
- [ ] 강화 풍차베기·빈틈없는자세·전략수정·포식자: 강화 카드가 기본 효과라도 발동하는지 (종전엔 무효과)
- [ ] 수치: G4_H 방어 18(+이치 2), E4 피해 3, E55 피해 10, E56 3×2회, G52 카드당 +3, H45 꽃가루 시 14/무 시 7, H34 3장째 화합, H23 H0/H1만 반복 카운트

**테스트 통과 시**: 21회차·22회차 순서로 2커밋 → 푸시. **문제 발견 시**: 콘솔 로그 확보 후 분석 요청.
