...
- **13~17회차**: 커밋·푸시 완료 (P2-16: 44b3e219 / P2-15a: 38e8cc1d / P2-15b: 940b96e6 / P2-15c: 0cd7f453 / P2-12: 9ed232d6).
- **18회차 TMP 예제 폴더 삭제**: 작업 트리에 **미커밋 상태** (삭제 250파일 + 이동 4에셋). Anton SDF가 기본 폰트여서 GUID 보존 이동 후 삭제 — 깨진 참조 0건 검증 완료. **플레이 테스트 통과 후 커밋할 것.**
...
18회차(TMP 예제 삭제) 변경 확인 포인트 — 기본 폰트(Anton SDF)와 텍스처 2장이 이동됨:

- [ ] **메뉴/로비/전투 전반의 텍스트 렌더링 정상** (기본 TMP 폰트가 Anton SDF)
- [ ] 카드 강화 아웃라인, 오브 UI 머티리얼 표시 정상 (이동된 텍스처 사용처)
- [ ] 콘솔에 폰트/머티리얼 누락(마젠타·□□□) 없음

**테스트 통과 시**: 18회차분 커밋 (메시지 예: "TMP 예제 폴더 삭제 및 사용 중 에셋 4건 GUID 보존 이동") → 푸시
